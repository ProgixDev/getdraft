...
<style>
  :root{--green:#00B894;--green-d:#0E8C73;--ink:#12201C;--muted:#5D6E68;--line:#E3EAE7;--bg:#F8FBFA}
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .hero{background:linear-gradient(135deg,#0E1A17,#12332B 65%,#0E8C73 140%);color:#fff;padding:44px 22px 36px}
  ...
  .logo{width:30px;height:30px;border-radius:8px;background:var(--green);display:flex;align-items:center;justify-content:center;font-weight:800;color:#06231C;font-size:17px}
  .brand b{font-size:17px}.brand b span{color:var(--green)}
  .hero h1{font-size:30px;font-weight:800;max-width:820px;margin:0 auto}
  .hero p{color:#A9CFC4;margin-top:8px;max-width:820px;margin-left:auto;margin-right:auto;font-size:14px}
  main{max-width:820px;margin:0 auto;padding:34px 22px 60px}
  h2{font-size:20px;margin:34px 0 10px;color:var(--green-d)}
  h3{font-size:16px;margin:20px 0 6px}
  p,li{color:#2A3934;font-size:15px}
