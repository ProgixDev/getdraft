...
export const LocationSelectionScreen: React.FC<LocationSelectionScreenProps> = ({
    ...
    const popularCities: Location[] = [
        { name: 'New York', city: 'New York', country: 'USA', lat: 40.7128, lng: -74.0060, formatted: 'New York, NY, USA' },
        { name: 'Los Angeles', city: 'Los Angeles', country: 'USA', lat: 34.0522, lng: -118.2437, formatted: 'Los Angeles, CA, USA' },
        { name: 'London', city: 'London', country: 'UK', lat: 51.5074, lng: -0.1278, formatted: 'London, United Kingdom' },
        { name: 'Paris', city: 'Paris', country: 'France', lat: 48.8566, lng: 2.3522, formatted: 'Paris, France' },
        { name: 'Tokyo', city: 'Tokyo', country: 'Japan', lat: 35.6762, lng: 139.6503, formatted: 'Tokyo, Japan' },
        { name: 'Dubai', city: 'Dubai', country: 'UAE', lat: 25.2048, lng: 55.2708, formatted: 'Dubai, UAE' },
    ];
    ...
    const searchLocations = async (query: string) => {
        ...
        try {
            ...
            const locations: Location[] = response.data.features.map((feature: any) => {
            ...
            <View style={styles.content}>
                ...
                <Animated.View entering={FadeIn.duration(800)} style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>
                        Search for your city worldwide
                    </Text>
                </Animated.View>
