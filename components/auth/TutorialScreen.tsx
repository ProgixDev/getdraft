...
const tutorialSlides: TutorialSlide[] = [
    ...
    },
    {
        ...
        description: 'Not a match? Swipe left or tap the X to pass and move on to the next profile.',
    },
    {
        id: '3',
        icon: 'people',
        title: 'It\'s a Match!',
        description: 'When both you and another user like each other, it\'s a match! You\'ll both be notified.',
    },
    {
        id: '4',
        icon: 'chatbubbles',
        title: 'Start Conversations',
        description: 'Once matched, start a conversation and take your connection to the next level.',
    },
];
                ...
                <View style={styles.footer}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Ionicons
                                name={currentIndex < tutorialSlides.length - 1 ? 'arrow-forward' : 'rocket'}
                                size={22}
                                color={brand.primary}
                            />
                        </LinearGradient>
