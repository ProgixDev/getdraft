...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    pulse.value = withRepeat(withTiming(1.15, { duration: 4000 }), -1, true);
  }, []);
  ...
  return (
    <View style={slideStyles.container}>
      ...
      <View style={slideStyles.decorativeContainer}>
        ...
        <BlurView
          intensity={15}
          style={[slideStyles.blurCircle, slideStyles.blurLarge]}
        >
          <View
            style={[slideStyles.decorativeCircle, slideStyles.circleLarge]}
          />
        </BlurView>

        <BlurView
          intensity={20}
          style={[slideStyles.blurCircle, slideStyles.blurMedium]}
        >
          <View
            style={[slideStyles.decorativeCircle, slideStyles.circleMedium]}
          />
        </BlurView>

        <BlurView
          intensity={10}
          style={[slideStyles.blurCircle, slideStyles.blurSmall]}
        >
          <View
            style={[slideStyles.decorativeCircle, slideStyles.circleSmall]}
          />
        </BlurView>

        {/* Accent shapes without blur */}
        <View
          style={[slideStyles.decorativeCircle, slideStyles.circleAccent1]}
        />
        <View
          style={[slideStyles.decorativeCircle, slideStyles.circleAccent2]}
        />
      </View>
