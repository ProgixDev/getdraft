...
export type UploadBucket = 'avatars' | 'photos' | 'videos';
...
export const uploadsService = {
  async getSignedUploadUrl(bucket: UploadBucket, fileName: string): Promise<SignedUploadResult> {
   ...
   */
  async uploadBlob(signedUrl: string, file: Blob, contentType: string): Promise<void> {
   ...
   */
  async uploadFromUri(signedUrl: string, fileUri: string, contentType: string): Promise<void> {
