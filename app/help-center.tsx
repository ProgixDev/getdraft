    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.contactSection}>
          ...
          <Pressable
            style={({ pressed }) => [styles.contactRow, styles.contactRowLast, pressed && styles.contactRowPressed]}
            onPress={() => Alert.alert('Replay Tutorial', 'Tutorial replay is coming soon!')}
          >
            <View style={styles.contactIcon}>
              <Ionicons name="play-circle-outline" size={20} color={theme.text} />
            </View>
            <View style={styles.contactCopy}>
